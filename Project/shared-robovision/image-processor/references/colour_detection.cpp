...
int main(int argc, char** argv) {
	...
	while (true) {
		...
		Mat imgThresholded_resized; //dst image
		resize(imgThresholded, imgThresholded_resized, size);

		imshow("Thresholded Image", imgThresholded_resized); //show the thresholded image
